...
class TabelasAlterar_planos extends CI_Controller
{
  ...
  public function up()
  {
   ...
   $user = "planos";
    ...
    helperconstruct_table_insert_fields( $user,'valor','int','11',Null,Null);
    helperconstruct_table_insert_fields( $user,'nome','varchar','255',Null,Null);
    helperconstruct_table_insert_fields( $user,'planos','varchar','255',Null,Null);
